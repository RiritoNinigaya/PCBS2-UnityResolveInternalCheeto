...
public:
	...
	struct Class final {
		...
		template <typename RType>
		auto SetValue(void* obj, const std::string& name, RType value) -> bool { return *reinterpret_cast<RType*>(reinterpret_cast<uintptr_t>(obj) + Get<Field>(name)->offset) = value; }
